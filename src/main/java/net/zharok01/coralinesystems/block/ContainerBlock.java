...
public class ContainerBlock extends Block implements EntityBlock {
    ...
    public BlockEntity newBlockEntity(@NotNull BlockPos pos, @NotNull BlockState state) {
        return new net.zharok01.coralinesystems.block.ContainerBlockEntity(pos, state);
    }
    ...
    public void onRemove(BlockState state, @NotNull Level level, @NotNull BlockPos pos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof net.zharok01.coralinesystems.block.ContainerBlockEntity grave) {
